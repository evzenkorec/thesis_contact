...
def postprocessing(R,E,nu,penetration,penalty, u, mesh, boundary_markers):
    ...
    plt.close("all")
    return 1e-3*top_subdomain_reaction()[2][0], 1e-3*Hertz_solution()[1], 1e-3*contact_subdomain_reaction()[2][0]
