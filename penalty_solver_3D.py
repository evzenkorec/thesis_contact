...
def penalty_solver(R,E,nu,penetration,penalty, mesh, boundary_markers):    
    ...
    Pi = psi*dx + 1/2*(penalty*E/hMESH)*inner(maculay(-gap(u)),maculay(-gap(u)))*ds(3)
    ...
    # Save solution as .xdmf for postprocessing
